...
public class WordSearch {
     ...
     * we need to determine if the word can be constructed from letters of sequentially adjacent cells. 
     ...
     * [2] Call depth-first search to search for the next character of the search word in the four possible directions for each cell of the grid.
     * [3] If a valid character is found, call the depth-first search function again for this cell.
     * [4] Continue searching through the cells until either the search word is found or all cells in the grid have been visited.
     */
