...
public class JumpGame {
     ...
     * squares, with the goal of reaching the last square.
     * 
     ...
     * either 3 steps, or 2 steps, or 1 step in the direction of the last square.
     * The player cannot move in the opposite direction, that is, away from the last
     * square.
     * You have been tasked with writing a function to validate whether a player can
     * win a given game or not.
     * You’ve been provided with the nums integer array, representing the series of
     * squares. The player starts at the first index and, following the rules of the
     * game, tries to reach the last index.
     * If the player can reach the last index, your function returns TRUE;
