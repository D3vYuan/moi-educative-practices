...
public class Subsets {
     ...
     * 
     * Strategy
     * [1] Compute the number of possible subsets of the given set using 2^n, where
     * n is the number of elements.
     * [2] Start a loop from 0 to the count of subsets and add an empty list to the
     * results list in the first iteration.
     ...
     * subset.
     * [4] After iterating over all elements in the input set, append the current
     * subset to the list of subsets.
     */
